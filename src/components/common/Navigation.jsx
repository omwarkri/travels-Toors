...
const Navigation = () => {
      ...
      <div className="bg-emerald-600 text-white">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
          <div className="flex justify-between items-center py-2">
            {/* Phone Number */}
           <a href="tel:+919028803309" className="flex items-center space-x-2 hover:text-blue-600 transition-colors duration-200">
  ...
  <span className="text-xs sm:text-sm font-medium">+91 90288 03309</span>
            ...
            <a
              ...
              className="flex items-center space-x-2 bg-green-600 hover:bg-green-700 px-3 py-1  transition-colors duration-200"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
