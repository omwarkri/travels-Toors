...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-md z-50 shadow-lg">
      {/* Compact Top Row - All in one line */}
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4">
          <div className="flex items-center justify-between">
            ...
            <a 
              ...
              className="flex items-center space-x-1 hover:text-blue-200 transition-colors duration-200 flex-shrink-0"
            >
              ...
              <span className="text-xs font-medium whitespace-nowrap">+91 90288 03309</span>
            </a>
            ...
            <a
              ...
              className="flex items-center space-x-1 bg-green-600 hover:bg-green-700 px-2 py-0.5 rounded transition-colors duration-200 flex-shrink-0 mx-2"
            >
              <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center space-x-1 flex-shrink-0">
              {socialLinks.map((social) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white hover:text-gray-200 transition-colors duration-200 p-0.5 rounded hover:bg-emerald-700"
      ...
      <div className="max-w-7xl mx-auto  sm:px-4 lg:px-6">
        <div className="flex justify-between items-center py-3 sm:py-2">
          ...
          {/* Desktop Navigation */}
          <div className="hidden lg:flex items-center space-x-3 xl:space-x-4 2xl:space-x-5">
            <a
              href="/"
              className="text-gray-700 hover:text-emerald-600 font-medium transition-colors duration-200 text-xs xl:text-sm"
              onClick={() => handleScrollTop("/")}
            >
              Home
            </a>
            ...
            <a
              href="/#contact"
              className="bg-emerald-500 text-white px-2 xl:px-3 2xl:px-4 py-1 font-medium hover:bg-emerald-600 transition-all duration-300 text-xs xl:text-sm rounded"
          ...
          <div className="hidden md:flex lg:hidden items-center space-x-2">
            <a
              href="/#packages"
              className="text-gray-700 hover:text-emerald-600 font-medium transition-colors duration-200 text-xs"
            >
              Packages
            </a>
            <a
            ...
            <a
              href="/#contact"
              className="bg-emerald-500 text-white px-2 py-1 font-medium hover:bg-emerald-600 transition-all duration-300 text-xs rounded"
            >
              Contact
            </a>
          </div>
        ...
        >
          <div className="flex flex-col space-y-1">
            <a
              href="/"
              className="text-gray-700 hover:text-emerald-600 font-medium py-1 px-3 rounded hover:bg-gray-50 transition-all duration-200 text-sm"
              onClick={() => handleScrollTop("/")}
            >
              Home
            </a>
            ...
            <a
              href="#contact"
              className="bg-emerald-500 text-white px-4 py-2 rounded font-medium hover:bg-emerald-600 transition-all duration-300 text-center mt-1 text-sm"
              onClick={() => handleScrollTop("/contact")}
            >
              Contact Us
            </a>
